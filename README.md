...
Team: Team ZO
Authors: Hannah Kim<sup>1)</sup>, Marija Stanojevic<sup>2)</sup>, Zoran Obradovic<sup>3)</sup>
...
H. K. obtained the dataset, did preliminary analysis of the dataset, and wrote the manuscript. M.S. and H. K. designed the general structure of the model. M. S. and H. K. optimized the model.
